...
public class DataManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Debug.Log(savePath);
        meshs.color = new Color(meshs.color.r, meshs.color.g, meshs.color.b, 0);
    }
    ...
    private void Update()
    {
        if(Input.GetKeyDown(KeyCode.N))
        {
            ...
            StartCoroutine(SaveCompleted(1.5f));
            SaveStart();
        }
    }
    ...
    IEnumerator SaveCompleted(float t)
    {
        while (meshs.color.a < 1)
        {
            float alpha = Time.deltaTime / t;
            meshs.color = new Color(meshs.color.r, meshs.color.g, meshs.color.b, meshs.color.a + alpha);
            yield return null;
        }
        meshs.color = new Color(meshs.color.r, meshs.color.g, meshs.color.b, 1);

        while (meshs.color.a > 0)
        {
            float alpha = Time.deltaTime / t;
            meshs.color = new Color(meshs.color.r, meshs.color.g, meshs.color.b, meshs.color.a - alpha);
            yield return null;
